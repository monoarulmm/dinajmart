                    ...
                    <div class="warning-box card-body">
                        <div class="media static-top-widget align-items-center">
                            ...
                            <div class="media-body media-doller">
                                ...
                                <h3 class="mb-0">$ <span class="counter">{{ $total_revenue }}</span><small> This
                                        Month</small>
                                </h3>
                            </div>
                        </div>
                    ...
                    <div class="warning-box card-body">
                        <div class="media static-top-widget align-items-center">
                            ...
                            <div class="media-body media-doller">
                                ...
                                <h3 class="mb-0">$ <span class="counter">{{ $total_order }}</span><small> This
                                        Month</small>
                                </h3>
                            </div>
                        </div>
                    ...
                    <div class="secondary-box card-body">
                        <div class="media static-top-widget align-items-center">
                            ...
                            <div class="media-body media-doller">
                                ...
                                <h3 class="mb-0">$ <span class="counter">{{ $total_product }}</span><small> This
                                        Month</small>
                                </h3>
                            </div>
                        </div>
                ...
                <div class="card o-hidden widget-cards">
                    <div class="secondary-box card-body">
                        <div class="media static-top-widget align-items-center">
                            ...
                            <div class="media-body media-doller">
                                <span class="m-0">Total-Order-Processing</span>
                                <h3 class="mb-0">$ <span class="counter">{{ $total_processing }}</span><small> This
                                        Month</small>
                                </h3>
                            </div>
                        </div>
                            ...
                            <table class="table table-bordernone">
                                ...
                                <tbody>
                                    @foreach ($orders as $order)
                                        <tr>
                                            <td>{{ $order->id }}</td>
                                            <td class="digits">${{ $order->subtotal }}</td>
                                            <td class="font-danger">{{ $order->payment_status }}</td>
